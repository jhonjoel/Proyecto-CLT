...
export class ListaVisitasByUsuarioService {
  
  private endpoint = '/visitasByUsuario';
  ...
  getListaVisitasByUsuario(fecha:Date,idUsuario:number ): Observable<any[]> {
    ...
    const requestData = { fecha:fecha ,idUsuario:idUsuario  };
